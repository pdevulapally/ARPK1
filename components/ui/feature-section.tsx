    ...
    <div className={cn("p-8 md:p-12", className)}>
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="flex flex-col md:grid md:grid-cols-2 gap-6 md:gap-10">
          ...
          <div
            className={cn(
              "order-1 md:order-2 relative min-h-[300px] md:min-h-[400px] lg:min-h-[500px] overflow-hidden rounded-lg"
            )}
          >
                  ...
                  index === currentFeature && (
                    ...
                    >
                      <Image
                        src={feature.image}
                        alt={feature.step}
                        className="max-w-full max-h-full object-contain transition-transform transform"
                        width={1000}
                        height={500}
                        priority
                      />
                      <div className="absolute bottom-0 left-0 right-0 h-1/3 bg-gradient-to-t from-white dark:from-gray-950 via-white/30 dark:via-gray-950/30 to-transparent" />
                    </motion.div>
                  ),
              )}
            </AnimatePresence>
