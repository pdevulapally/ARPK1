...
export function middleware(request: NextRequest) {
  ...
  const sensitive = path.startsWith("/api/") || path.startsWith("/app/actions/") || path.startsWith("/payment") || path.startsWith("/api/stripe") || path.startsWith("/payment/secure") || path.startsWith("/payment/confirm")
